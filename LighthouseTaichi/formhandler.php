...
$body ="Here is the message from your Form Homework Page!:\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: shan0015@seattlecentral.edu' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Second notification'; // if your client has more than one web site, you can put the site name here.
...
mail ('shan0015@seattlecentral.edu', $subject, $body, $from);
